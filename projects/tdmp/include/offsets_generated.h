...
namespace mp {
    ...
    namespace funcs {
        namespace types {
            ...
            namespace script_core {
                using tregisterLuaFunctions = std::add_pointer_t<void(mp::teardown::types::script_core_t* scriptCore)>;
                using tloadScript = std::add_pointer_t<void(mp::teardown::types::script_core_t* scriptCore, mp::teardown::types::td_string* name)>;
                using tdestroy = std::add_pointer_t<void(mp::teardown::types::script_core_t* scriptCore, char a2)>;
            }
            ...
            namespace teardown {
                using tinitialize = std::add_pointer_t<mp::teardown::types::game*(mp::teardown::types::game* game, DWORD** a2, int64_t a3)>;
                using tupdate = std::add_pointer_t<mp::teardown::types::game*(mp::teardown::types::game* game, int64_t input)>;
            }

            namespace registry {
                using tgetInt = std::add_pointer_t<int(uint8_t** registry, mp::teardown::types::td_string* str)>;
                using tgetFloat = std::add_pointer_t<float(uint8_t** registry, mp::teardown::types::td_string* str)>;
                using tgetString = std::add_pointer_t<mp::teardown::types::td_string*(uint8_t** registry, mp::teardown::types::td_string* str)>;
                using tsetBool = std::add_pointer_t<void(uint8_t** a1, mp::teardown::types::td_string* str, bool value)>;
                using tsetString = std::add_pointer_t<void(uint8_t** a1, mp::teardown::types::td_string* str, mp::teardown::types::td_string* value)>;
            }
        ...
        namespace script_core {
            static types::script_core::tregisterLuaFunctions registerLuaFunctions = nullptr;
            static types::script_core::tloadScript loadScript = nullptr;
            static types::script_core::tdestroy destroy = nullptr;
        }
        ...
        namespace teardown {
            ...
            static types::teardown::tupdate update = nullptr;
        }

        namespace registry {
            static types::registry::tgetInt getInt = nullptr;
            static types::registry::tgetFloat getFloat = nullptr;
            static types::registry::tgetString getString = nullptr;
            static types::registry::tsetBool setBool = nullptr;
            static types::registry::tsetString setString = nullptr;
        }
    ...
    namespace lua_funcs {
        ...
        namespace scriptControl{
                ...
                DECLARE_GAME_LUA_FUNCTION(Menu, 0x7ff6c15e6d30);
        }
        namespace entity{
                ...
                DECLARE_GAME_LUA_FUNCTION(RemoveTag, 0x7ff6c161eb1d);
                DECLARE_GAME_LUA_FUNCTION(HasTag, 0x7ff6c1620b0c);
